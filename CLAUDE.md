...
| [`docs/plano-storyboard-c3.md`](docs/plano-storyboard-c3.md) | Ao retomar a **Frente Storyboard · Ciclo 3 (A Máquina)** — a régua de passos (os dois números), o mapa do que a Máquina rege sem tocar, a anatomia do node, as fases e as decisões que esperam o Jorge. É o plano do ciclo, em disco. |
